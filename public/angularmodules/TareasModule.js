angular.module('moduleTareas', ['ui.router', 'ngMaterial', 'ngMdIcons'])
    ...
    .controller('ctrlDashboard', ['$scope', '$mdBottomSheet','$mdSidenav', '$mdDialog', 'comun', function($scope, $mdBottomSheet, $mdSidenav, $mdDialog, comun){ //Comun agregado por Israel
